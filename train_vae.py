...
def main_no_prop(params):
    ...
    tbCallBack = TensorBoard(log_dir='./logs_all_data_batch_1024',write_graph=True,write_grads=True,write_images=True)
    callbacks = [ vae_anneal_callback, csv_clb,tbCallBack]
