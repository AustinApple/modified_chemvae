...
def main_no_prop(params):
    ...
    Checkpoint = ModelCheckpoint("Model_70W_MP/weights.{epoch}-{val_loss}.hdf5", monitor='val_loss', verbose=0, save_best_only=False, save_weights_only=True, mode='auto', period=1)
...
if __name__ == "__main__":
    ...
    params["data_file"] = "zinc_70W_MP_canon.csv"
